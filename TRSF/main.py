...
Detector of astRonomical soUrces in optIcal and raDio images
    ...
    def phsf(self,lifetime_limit=0):
        ...
        if self.cutup == True:
            ...
            self.catalogue = compute_ph_components(self.image,self.local_bg,analysis_threshold_val=self.analysis_threshold_val,lifetime_limit=lifetime_limit,output=self.output)
