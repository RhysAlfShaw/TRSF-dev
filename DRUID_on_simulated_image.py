...
# load the simulation
findmysource = sf(image=None, image_PATH='Simulation_Image_radio'+str(args.sn)+'.fits', mode='Radio')
...
catalogue.write('DRUIDsimulation_catalogue'+str(args.sn)+'.fits',overwrite=True)